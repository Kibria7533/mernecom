...
class Uploadproduct extends Component {
  ...
  onDrop = (files) => {
    ...
    axios.post(`${URL}/api/product/uploadImage`, formData, config)
      .then(response => {
        if (response.data.success) {

          this.setState({ Images: [...this.state.Images, response.data.image] })
  ...
  onSubmit = (event) => {
    ...
    axios.post(`${URL}/api/product/uploadProduct`, variables)
      .then(response => {
        if (response.data.success) {
      ...
      <div className="container">
        ...
        <form onSubmit={this.onSubmit}>
          <div className="form-group">
            ...
            <input type="text" name="title" onChange={this.Change} value={this.state.title} className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Title" />

          </div>
          <div className="form-group">
            <label htmlFor="exampleInputEmail1">SKU Number</label>
            <input type="text" name="skunumber" onChange={this.Change} value={this.state.skunumber} className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Title" />
          ...
          <div className="form-group">
            ...
            <input type="text" name="price" onChange={this.Change} value={this.state.price} className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Price" />

          </div>
          <div className="form-group">
            <label htmlFor="exampleInputEmail1">Quantity</label>
            <input type="text" name="quantity" onChange={this.Change} value={this.state.quantity} className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Quantity" />

          </div>
          <div className="form-group">
            <label htmlFor="exampleInputEmail1">Weaight</label>
            <input type="text" name="weaight" onChange={this.Change} value={this.state.weaight} className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Quantity" />
          ...
          <div className="form-group">
            ...
            <input type="text" name="discount" onChange={this.Change} value={this.state.discount} className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Discount" />

          </div>
          <div className="form-group">
            <label htmlFor="exampleInputEmail1">Stock</label>
            <input type="text" name="stock" onChange={this.Change} value={this.state.stock} className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Stock" />
          ...
          <div className="form-check">
            <input type="checkbox" name="featured" onChange={this.feature} className="form-check-input" id="exampleCheck1" />
            <label className="form-check-label" htmlFor="exampleCheck1">Is Feature?</label>
          </div>
          <div className="form-check">
            <input type="checkbox" name="trend" onChange={this.trend} className="form-check-input" id="exampleCheck1" />
            <label className="form-check-label" htmlFor="exampleCheck1">Is Trend?</label>
          </div>
