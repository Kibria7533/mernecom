      ...
      {this.props.cart.map((item,index)=>{
        return(
          ...
          <div className="col-12 col-sm-12 col-md-2 text-center">
            <img className="img-responsive"  src={`http://localhost:5000/${item.Images[0]}`} alt="prewiew" width={120} height={80} />
          </div>
          ...
          <div className="col-12 col-sm-12 text-sm-center col-md-4 text-md-right row">
            ...
            <div className="col-4 col-sm-4 col-md-4">
              <div className="quantity">
                <input type="button" onClick={()=>this.props.addToCarthandler(item._id,"add")}  defaultValue="+" className="plus" />
                <input type="text" step={1} max={99} min={1} value={item.quantity} title="Qty" className="qty" size={4} />
                <input type="button" defaultValue="-" onClick={()=>this.props.addToCarthandler(item._id,"minus")} className="minus" />
              </div>
            </div>
