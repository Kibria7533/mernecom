...
<a onClick={this.addresset}>  <input type="button" value="Place Order" className="btn" style={{
...
<PaypalExpressBtn env={this.env}  style={{
                                    size: 'large',
                                    color: 'blue',
                                    shape: 'rect',
                                    label: 'checkout'
