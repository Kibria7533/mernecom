    ...
    <div className="card-body">
      ...
      <article className="card">
        <div className="card-body row">
          <div className="col-md-4"> <strong>Estimated Delivery time:</strong> <br />29 nov 2019 </div>
          <div className="col-md-4"> <strong>Shipping BY:</strong> <br /> BLUEDART, | <i className="fa fa-phone" /> +1598675986 </div>
      ...
      <ul className="row">
        ...
        <li className="col-md-4">
          <figure className="itemside mb-3">
            <div className="aside"><img src="https://res.cloudinary.com/dxfq3iotg/image/upload/v1571750967/Ecommerce/ef192a21ec96.jpg" className="img-sm border" /></div>
            <figcaption className="info align-self-center">
        ...
        <li className="col-md-4">
          <figure className="itemside mb-3">
            <div className="aside"><img src="https://res.cloudinary.com/dxfq3iotg/image/upload/v1571750722/Ecommerce/acer-v-17-nitro-realsense.jpg" className="img-sm border" /></div>
            <figcaption className="info align-self-center">
