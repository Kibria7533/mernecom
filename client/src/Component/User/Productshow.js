      ...
      .then(response => {
        if (response.data.success) {
          if (variables.loadMore) {
            this.setState({ Products: [...this.state.Products, response.data.products[0]] })
...
<div className="d-flex justify-content-around fixed  " style={{ marginTop: "32px",border: "5px double #1C6EA4",background:" #D0E4F5"}}>
  <div>
    <RadioBox
      list={price}
  ...
  <div >
    <SearchBox placeholder="Enter search term" value={this.state.searchBoxVal} onchange={this.handleSearchBoxValChange}
      ...
      searchButtonStyles={{ background: "dodgerBlue", border: "1px solid blue", padding: "0px" }}
            ...
            <div className="container-fluid">
              ...
              <div className="row">
                {this.state.Products.map((item, index) => {
                  return (
                    <div key={index} className="col-12 col-md-6 col-lg-3" style={{ minWidth:"320px"}} >
                      <div className="single-publication">
                        ...
                        <div className="publication-content">
                          ...
                          <h3><a  href={`/singleproduct/${item._id}`}>{item.title}</a></h3>
                          <ul>
                          ...
                          <h4 className="price">${item.price}<span>$299</span></h4>
                        </div>
                        <div className="add-to-cart">
                          <button  onClick={()=>this.props.addToCarthandler(item._id,"add")} className="default-btn">Add to Cart</button>
                        </div>
                      </div>
                    </div>
