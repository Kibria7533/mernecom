...
class User extends Component {
    ...
    async componentDidMount() {
        ...
        await Axios.get(`${URL}/api/users/profile`, {
            ...
            if (wishitems.length) {
                await Axios.get(`${URL}/api/product/products_by_id?id=${wishitems}&type=array`)
                    .then(result=>{
    ...
    render() {
        ...
        return (
            <BrowserRouter>
                <div>
                    <Header addtocart={this.state.addtocart} wishlistnumber={this.state.wishlistnumber}/>

                    <div className='container-fluid mainContent'>
                        {/* <Breadcrumbs /> */}
                        <Switch>
                            <Route exact path='/wishlist' render={props => <Wishlist wish={this.state.wish}  addToCarthandler={this.addToCarthandler} removeFromWish={this.removeFromWish}  addtocartupdate={this.addtocartupdate} />} />
                            ...
                            <Route exact path='/' render={props => <Productshow {...props} addTowishlist={this.addTowishlist} removeFromWish={this.removeFromWish} addToCarthandler={this.addToCarthandler} />} />
                            <Route exact path='/:category' render={props => <Productshow {...props} addTowishlist={this.addTowishlist} removeFromWish={this.removeFromWish} addToCarthandler={this.addToCarthandler} />} />
                        </Switch>
                    </div>
                    <Footer />
                </div>
